...
<body>
  ...
  <main>
    <div data-aos="fade-up" data-aos-duration="500" class="blog-head">
      <img src="assets/img/cursor.png" class="cursor" alt="">
      <img src="assets/img/scribble.png" class="arrow" alt="">
      <img src="assets/img/quote.png" class="left-quote" alt="">
      <img src="assets/img/quote.png" class="right-quote" alt="">
      <div class="container">
        <h1>Blog</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque magni rem magnam ducimus ea porro voluptate officiis quos commodi nemo, accusamus optio! Illum, impedit rerum.</p>
      </div>
    </div>

    <div data-aos="fade-down" data-aos-duration="500" class="blog-body">
      <div class="container">
        <div class="first-row row">
          <div class="overflow-hidden d-flex-full col-md-5">
            <div  class="img-box w-100">
              <img src="assets/img/blog-10.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div class="right-section d-flex-full col-md-7">
            <div class="txt-box">
              <span>Sponsered</span>
              <h3>What Spices are in curry?</h3>
              ...
              <p style="font-weight: bold;" class="m-0 mt-3">- Owner -</p>
            </div>
          </div>
        </div>
      </div>
