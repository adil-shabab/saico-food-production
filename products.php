...
<head>
  <title>Products | Saico Food</title>



  <meta name="title" content="Products | Saico Foods">
...
<body>
 ...
 <?php include 'include/header.php' ?>
  ...
  <main>
    <div class="product-home product-home-1">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-12 mb-lg-0 mb-3">
            <div class="column">
              <img data-aos="fade-up" data-aos-duration="700" src="assets/img/banner-1.jpg" class="img-fluid" alt="">
            </div>
          </div>
          <div class="col-md-6 col-12 mb-lg-0 mb-3">
            <div class="column">
              <img data-aos="fade-up" data-aos-duration="900" src="assets/img/banner-2.jpg" class="img-fluid" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="product-home product-home-2">
      ...
      <!-- <img src="assets/img/top-left.png" class="nature-2" alt=""> -->
      <h1 class="text-center" data-aos="fade-up" data-aos-duration="300">Shop By Category</h1>
      <div class="container">
        <div class="mt-5 row">
